...
import com.yfhx.VO.TestSmsQueryVO;
import com.yfhx.VO.TestSmsVO;
...
public class TestSmsController {
    ...
    @ResponseBody
    public CommonResult<List<TestSmsVO>> select(@RequestBody TestSmsQueryVO vo) {
        try {
            checkNotNull(vo);
