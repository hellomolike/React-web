...
import com.yfhx.VO.TestQueryVO;
import com.yfhx.VO.TestVO;
...
public class TestController {
    ...
    @ResponseBody
    public CommonResult<List<TestVO>> select(@RequestBody TestQueryVO vo) {
        try {
            checkNotNull(vo);
            List<TestVO> result = Lists.newArrayList();
    ...
    @ResponseBody
    public CommonResult<TestVO> insert(@RequestBody TestVO vo) {
        try {
            checkNotNull(vo);
    ...
    @ResponseBody
    public CommonResult<Integer> update(@RequestParam("keys") String keys, @RequestBody TestVO vo) {
        try {
            checkNotNull(keys);
            checkNotNull(vo);
